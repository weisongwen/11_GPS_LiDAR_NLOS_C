...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/wenws/11_GPS_LiDAR_NLOS_C/src/ndt_omp)
  set(ndt_omp_DEVEL_PREFIX /home/wenws/11_GPS_LiDAR_NLOS_C/devel)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/wenws/11_GPS_LiDAR_NLOS_C/install)
...
if(NOT "/home/wenws/11_GPS_LiDAR_NLOS_C/src/ndt_omp/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/wenws/11_GPS_LiDAR_NLOS_C/src/ndt_omp/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'koide <koide@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wenws/11_GPS_LiDAR_NLOS_C/src/ndt_omp/${idir}'.  Ask the maintainer 'koide <koide@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ndt_omp_dep}_FOUND)
      find_package(${ndt_omp_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ndt_omp_dep} REQUIRED ${depend_list})
  endif()
